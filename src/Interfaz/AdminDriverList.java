...
public class AdminDriverList extends JDialog {
	...
	public static void main(String[] args) {
		try {
			AdminDriverList dialog = new AdminDriverList();
	...
	public AdminDriverList() {
		...
		table = new JTable();
		AdminDriverListTableModel tableModel = new AdminDriverListTableModel();
