...
public class ListadoSolicitudes extends JDialog {
	...
	public ListadoSolicitudes() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(ListadoSolicitudes.class.getResource("/image/document.png")));
		...
		table = new JTable();
		ListadoSolicitudesTableModel tableModel = new ListadoSolicitudesTableModel();
