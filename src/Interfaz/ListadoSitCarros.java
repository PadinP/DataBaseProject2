...
public class ListadoSitCarros extends JDialog {
	...
	public static void main(String[] args) {
		try {
			ListadoSitCarros dialog = new ListadoSitCarros();
	...
	public ListadoSitCarros() {
		...
		table = new JTable();
		ListadoSitCarrosTableModel tableModel = new ListadoSitCarrosTableModel();
