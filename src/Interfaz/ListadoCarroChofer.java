...
public class ListadoCarroChofer extends JDialog {
	...
	public static void main(String[] args) {
		try {
			ListadoCarroChofer dialog = new ListadoCarroChofer();
	 ...
	 * Create the dialog.
	 */
	public ListadoCarroChofer() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(ListadoCarroChofer.class.getResource("/image/OIP (2).jpg")));
		setTitle("Lista de la Relación Carro-Chofer");
		setAlwaysOnTop(true);
		this.repaint();
		...
		table = new JTable();
		ListadoCarroChoferTableModel tableModel = new ListadoCarroChoferTableModel();
