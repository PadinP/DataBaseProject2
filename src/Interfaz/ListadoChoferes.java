...
public class ListadoChoferes extends JDialog {
	...
	public static void main(String[] args) {
		try {
			ListadoChoferes dialog = new ListadoChoferes();
	...
	public ListadoChoferes() {
		...
		table = new JTable();
		ListadoChoferesTableModel tableModel = new ListadoChoferesTableModel();
