...
public class ListadoArrastres extends JDialog {
	...
	public static void main(String[] args) {
		try {
			ListadoArrastres dialog = new ListadoArrastres();
	 ...
	 * Create the dialog.
	 */
	public ListadoArrastres() {
		setTitle("Lista de Arrastres");
		setAlwaysOnTop(true);
		this.repaint();
		...
		table = new JTable();
		ListadoArrastresTableModel tableModel = new ListadoArrastresTableModel();
