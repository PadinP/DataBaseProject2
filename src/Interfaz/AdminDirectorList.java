...
public class AdminDirectorList extends JDialog {
	...
	public static void main(String[] args) {
		try {
			AdminDirectorList dialog = new AdminDirectorList();
	...
	public AdminDirectorList() {
		...
		table = new JTable();
		AdminDirectorListTableModel tableModel = new AdminDirectorListTableModel();
